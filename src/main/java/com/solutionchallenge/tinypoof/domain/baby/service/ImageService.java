...
import com.solutionchallenge.tinypoof.domain.baby.entity.UploadFile;
...
public class ImageService {
    ...
    public GetS3ImageRes upload(MultipartFile multipartFile) throws IOException {
        ...
        return GetS3ImageRes.builder().imageUrl(storeFileUrl).build();
    }
